...
const SidebarNavigation = ({ activeSection }: SidebarNavigationProps) => {
  const t = useTranslations("Sesion3");
  return (
      ...
      <main className="relative z-10 pt-20 pb-12 max-w-7xl mx-auto px-4 sm:px-8 lg:px-32 xl:px-40 md:pr-72">
        ...
        >
          ...
          <ul className="list-disc list-inside text-lg mb-4">
            ...
            <li>
              <strong>{t("contenido_list_item5")}</strong>
            </li>
            <li>
              <strong>{t("contenido_list_item6")}</strong>
            </li>
            <li>
              <strong>{t("contenido_list_item7")}</strong>
            </li>
            <li>
              <strong>{t("contenido_list_item8")}</strong>
            </li>
            <li>
              <strong>{t("contenido_list_item9")}</strong>
            </li>
          </ul>
                ...
                >
                  <div className="mb-16">
                    ...
                    <div className="w-full h-[600px] bg-gray-900 rounded-2xl overflow-hidden shadow-2xl hover:shadow-teal-500/20 transition-shadow">
                      <iframe
                        src="/slides/2025_SemilleroCV_Session3_DeepLearning.pdf"
                        width="100%"
                        height="100%"
                  ...
                  <div className="relative aspect-video bg-gray-900 rounded-2xl overflow-hidden shadow-2xl hover:shadow-teal-500/20 transition-shadow">
                    <iframe
                      width="100%"
                      height="100%"
                      src="https://www.youtube.com/embed/mp1rws_NQsQ?si=95Gt1Rk8F78y4IZY"
