      ...
      <main className="relative z-10 pt-20 pb-12 max-w-7xl mx-auto px-4 sm:px-8 lg:px-32 xl:px-40 md:pr-72">
          ...
          <div className="md:w-1/2">
            ...
            >
              ...
              <p className="mt-4 text-lg md:text-xl">
                ...
                acompa&ntilde;an en este emocionante camino.
              </p>
            </motion.div>
          </div>
        </section>
        ...
        >
          ...
          <p className="text-lg leading-relaxed">
            ...
            sentando las bases para profundizar en conceptos m&aacute;s
            avanzados.
          </p>
        </motion.section>
        ...
        >
          ...
          <ul className="list-disc list-inside text-lg mb-4">
            ...
            >
              &quot;How we&apos;re teaching computers to understand
              pictures&quot;
            </a>
            <br></br>
            <a
        ...
        >
          ...
          <p className="text-lg leading-relaxed mb-4">
            ...
            de im&aacute;genes, fundamentos de Deep Learning y t&eacute;cnicas
            de an&aacute;lisis visual. Todo se desarrolla de manera
            din&aacute;mica y participativa.
          </p>
          <p className="text-lg leading-relaxed">
            Fomentamos la interacci&oacute;n y el debate, permiti&eacute;ndote
            experimentar con ejemplos reales y sentar las bases para proyectos
            futuros.
          </p>
        </motion.section>
        ...
        >
          ...
          <p className="text-lg leading-relaxed mb-4">
            ...
            preparar el terreno para los siguientes m&oacute;dulos.
          </p>
          <p className="text-lg leading-relaxed">
            Adem&aacute;s, promoveremos el intercambio de ideas en grupo,
            permitiendo la discusi&oacute;n y resoluci&oacute;n de dudas en un
