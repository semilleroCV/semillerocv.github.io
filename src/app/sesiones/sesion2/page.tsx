    ...
    <div className="relative min-h-screen text-white overflow-x-hidden">
      ...
      <main className="relative z-10 pt-20 pb-12 max-w-7xl mx-auto px-4 sm:px-8 lg:px-32 xl:px-40 md:pr-72">
          ...
          <div className="md:w-1/2">
            ...
            >
              ...
              <p className="mt-2 text-lg md:text-xl">
                En esta sesión, exploramos la transición desde la luz hasta la imagen digital. Nos sumergiremos en los principios fundamentales de la formación de imágenes, desde los conceptos ópticos hasta el procesamiento digital, estableciendo las bases esenciales para comprender cómo las cámaras capturan y procesan la luz.
              </p>
            </motion.div>
          </div>
        </section>
        ...
        >
          ...
          <p className="text-lg leading-relaxed mb-4">
            En esta sesión, combinamos teoría y práctica para explorar los siguientes temas:
          </p>
          <ul className="list-disc list-inside text-lg mb-4">
            <li>
              <strong>Formación de imágenes:</strong> Explicación del concepto de la cámara oscura, la propagación de la luz y la relación entre el campo de visión (FOV), el ángulo de visión (AOV) y la profundidad de campo (DoF).
            </li>
            <li>
              <strong>El triángulo de la exposición:</strong> Análisis de la velocidad de obturación (shutter speed), la apertura del diafragma y la sensibilidad ISO.
            </li>
            <li>
              <strong>Imágenes digitales:</strong> Transformación de un dominio continuo a uno digital, profundidad de bits y tipos de imágenes (binarias, escala de grises, color, espectrales, video, etc.).
            </li>
            <li>
              <strong>Sensores ópticos:</strong> Anatomía de un sensor, diferencias entre CMOS y CCD, balance de blancos, demosaicking y ruido en la imagen.
            </li>
            <li>
              <strong>Pipeline de procesamiento de imágenes:</strong> Etapas del procesamiento desde la captura hasta la imagen final.
            </li>
            <li>
              <strong>Transformaciones de imágenes:</strong> Corrección de gamma, ecualización de histograma, filtrado lineal y convolución 2D.
            </li>
          </ul>
          <p className="text-lg leading-relaxed">
            La sesión será participativa e incluirá demostraciones prácticas para reforzar los conceptos teóricos.
          </p>
        </motion.section>
        ...
        >
          ...
          <p className="text-lg leading-relaxed mb-4">
            Al finalizar la sesión, se asignarán ejercicios prácticos para consolidar los conocimientos adquiridos. Estas actividades incluirán:
          </p>
